...
public class User {
	...
	private List<Realty> recordedRealtyList;
	...
	public List<Realty> getRecordedRealtyList() {
		return recordedRealtyList;
	}

	public void setRecordedRealtyList(List<Realty> recordedRealtyList) {
		this.recordedRealtyList = recordedRealtyList;
	}
	public void setRecordedRealty(Realty realty) {
		recordedRealtyList.add(realty);
	}
