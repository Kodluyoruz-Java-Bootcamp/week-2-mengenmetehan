package src.main.java.com.metehanmengen.example2.creational_design_patterns.prototype;
...
public class Prototype implements Cloneable {
    ...
    @Override
    protected Prototype clone()  { //Deep copy ile elemanlar yeni nesneye atadın. Değerleri aynı olan yeni nesne oluşturuldu.
    ...
    public static void test()  {
        ...
        // Deep copy yaptığımız için değerler korundu.
